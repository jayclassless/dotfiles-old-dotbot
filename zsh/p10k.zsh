# Generated by Powerlevel10k configuration wizard on 2020-07-12 at 08:39 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='K8S'
  ...
  # Custom segment that runs vcsinfo
  function prompt_vcsinfo() {
    if type vcsinfo &>/dev/null; then
      VCSINFO="$(vcsinfo)"
      p10k segment -f yellow -t "$VCSINFO"
    else
      prompt_vcs
    fi
  }
